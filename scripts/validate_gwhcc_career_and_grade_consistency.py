...
DUPLICATE_REVIEW = {
    ...
    "Ahilan Sivakumaran": ("CONFIRMED SAME PERSON", "Merged through governed manual mapping after non-overlapping season and match-ID continuity review (FB02)."),
    ...
    "Greg Mccormick": ("CONFIRMED SAME PERSON", "Merged through governed manual mapping after non-overlapping season and match-ID continuity review (FB01); headline source conflict remains documented."),
    ...
    "Reece Anderson": ("CONFIRMED SAME PERSON", "Merged through governed manual mapping after non-overlapping season and match-ID continuity review (FB03)."),
    "Dulaj Madushanka": ("CONFIRMED SAME PERSON", "Expanded-name and abbreviated provider profiles merge after non-overlapping review and exact customer career reconciliation."),
